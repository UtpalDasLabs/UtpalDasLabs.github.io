...
export const companies = {
  ...
  semiClient: { name: "Semiconductor industry" },
  clampingClient: { name: "Clamping-technology manufacturer" },
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "Adaptive Clamping Automation",
    category: "Industrial & Vision",
    tags: ["AUTOMATION", "CAD ALGORITHMS"],
    year: "2016–2017",
    companies: [companies.clampingClient],
    description:
      "Software that makes a universal clamping-pin field adapt itself to any freeform part — computing per-pin Z-shifts from the CAD contour so the fixture physically reshapes to hold what it is about to machine. Project lead from feasibility prototype and projection algorithms to architecture and delivery plan, built as modular libraries reusable across products. Internal codename: ROLEX.",
    coverImage: engineeringA,
    images: [engineeringA],
  },
  {
    ...
    category: "Industrial & Vision",
    tags: ["MACHINE LEARNING", "AI SINCE 2017"],
    year: "2017–2018",
    companies: [companies.semiClient],
    description:
      "I was training neural networks for industrial inspection in 2017 — years before AI became fashionable. Machine-learning defect detection (Caffe) on computed-tomography scans of precision components for semiconductor manufacturing: volumetric scan import, defect classification by probability, type, size and rest-wall thickness, and a trainable master/user workflow where engineers teach the model new defect classes. Project lead from requirement definition through delivery.",
    coverImage: engineeringA,
    images: [engineeringA],
  },
  {
